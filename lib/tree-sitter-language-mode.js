...
class TreeSitterLanguageMode {
  constructor ({buffer, document, scopeMap, foldConfig, scopeDescriptor, grammar}) {
    this.buffer = buffer
    this.grammar = grammar
    this.scopeMap = scopeMap
    this.foldConfig = foldConfig
  ...
  getFoldableRangesAtIndentLevel (indentLevel) {
    let result = []
  ...
  scopeDescriptorForPosition (point) {
    const ScopeDescriptor = this.rootScopeDescriptor.constructor
